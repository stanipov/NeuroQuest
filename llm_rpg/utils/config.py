    ...
    return {
        ...
        "llm_providers": {
            "lore_llm": {
                ...
                "props": {"temperature": 1.0, "max_tokens": 4000},
            },
            "npc_ai_llm": {
                "provider": "groq",
                "model": "openai/gpt-oss-120b",
                "api_key_env": "GROQ_API_KEY",
                "props": {"temperature": 0.7, "max_tokens": 2000},
            },
            "game_ai_llm": {
                "provider": "groq",
                "model": "openai/gpt-oss-120b",
                "api_key_env": "GROQ_API_KEY",
                "props": {"temperature": 0.5, "max_tokens": 2000},
            },
            "input_validator": {
                "provider": "groq",
                "model": "openai/gpt-oss-120b",
                "api_key_env": "GROQ_API_KEY",
                "props": {"temperature": 0.25, "max_tokens": 2000},
            },
        },
        "lore_generation": {
            "num_npc_rules": 10,
